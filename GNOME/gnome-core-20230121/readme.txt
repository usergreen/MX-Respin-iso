...
This updated version is now shown as "mx-respin-iso-21.3_x64 (January 21, 2023).
...
Note:
gnome-core-xxxxxxxx.iso is identical to gnome-core-ja-xxxxxxxx.iso besides "boot parameter" below.

gnome-core-xxxxxxxx.iso ----- Default language (locale) is NOT set. You should choose from among pull-down list.
gnome-core-ja-xxxxxxxx.iso -- Default language (locale) is set to "ja_JP" for Japanese and JST.
