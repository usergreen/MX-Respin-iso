2023-08-02 16:52 UTC
updated: 2023-08-15 04:57 UTC
...
A snapshot is modified thoroughly from 
MX-23_CLI_x64 Libretto July 31, 2023, and applied all latest updates so far.
...
There is no installer icon on Desktop, but no worry.
In order to install this respin into an internal hard disc, run the following command from GNOME Terminal as root
...
Modified from Communitty Respin of
MX-23_CLI_x64 Libretto July 31, 2023
https://sourceforge.net/projects/mx-linux/files/Community_Respins/MX-CLI/

** Optional locales (L10n)
Many are available, and the following locales are fully supported (localized):
...
Note:
As for this ISO image file: Default locale is NOT set. You should choose your locale from among pull-down list.
