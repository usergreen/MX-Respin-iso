...
updated: 2023-11-20 14:10 UTC

Read this README.txt file first, before using this snapshot for x64 architecture. The ISO image can be used as Live USB/DVD or for HDD installation.

This snapshot provides Xfce Desktop environment along with office suite, mailer, printing and file server, etc.
...
Modified from Community respin of MX-19.3_Base_x64
...
Note:
As for mx-19-respin-xfce-xxx.iso, the default language (locale) is NOT set. So, choose your desired locale from among pull-down list at boot menu.
