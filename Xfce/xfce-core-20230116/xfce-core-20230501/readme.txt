...
This snapshot is based on unofficial MX-21.1_x64 Wildflower 18 May 2022. But now this snapshot is fully updated to "MX Respin iso-21.3_x64 (January 16/17, 2023 )", based on Debian 11.7.
...
Note:
xfce-core-20230501_0648.iso ----- Default language (locale) is set to "en_US" for English and UTC.
