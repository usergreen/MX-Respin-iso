2023-07-24 02:56 JST
updated: 2023-11-16 05:30 UTC
...
A snapshot is modified thoroughly from MX-23_CLI_x64 July 31 2023, and applied all latest updates so far.
...
** Downloading sites
An updated version is usually available at https://sourceforge.net/projects/mx-respin-enlightenment/

** Origin of this snapshot.iso
Modified from Community respin of
MX-23_CLI_x64 July 31 2023
...
Note:
Muted by default (That is to say; you need to deselect check to enable sound).

mx-23-respin-enlightenment-xxxxxx.iso ----- Default locale is not set. You should choose from among pull-down list.
You can also choose whatever locale you want to use from Enlightenment Setting Menu.
