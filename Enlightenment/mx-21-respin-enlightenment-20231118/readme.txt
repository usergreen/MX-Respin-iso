...
A snapshot is modified thoroughly from MX-21.3_minimal_x64 Wildflower Jan 15 2023, and applied all latest updates so far.
...
MX-21.3_minimal_x64 Wildflower Jan 15 2023
...
Note:
mx-21-respin-enlightenment-xxxxxx.iso ----- Default locale is set to none. So, you should choose from among the pull-down list.
