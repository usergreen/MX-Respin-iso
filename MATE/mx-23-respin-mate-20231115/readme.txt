...
A snapshot is modified thoroughly from MX-23_CLI_x64.iso, 31 July 2023, and applied all latest updates so far.
...
Note:
As for mate-r23-xxxxxxxx.iso, default language (locale) is NOT. You should choose your locale from among pull-down list.

You are free to choose whatever locale you want to use at Boot Menu Option.
