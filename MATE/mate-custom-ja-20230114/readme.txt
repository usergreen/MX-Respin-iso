...
This updated version is now shown as "mx-respin-iso-21.2.1_x64 (January 14, 2023), which is based on Debian 11.6.

Default locale is set ja_JP.UTF-8, US or Japanese keyboard-layout and Japanese Standard Time (JST), but you can change to whatever locale you want to use from Boot Menu Option.
