...
This updated version is now shown as "mx-respin-iso-21.3_x64 (January 20, 2023).
...
Note:
mate-core-xxxxxxxx.iso is identical to mate-core-ja-xxxxxxxx.iso besides "boot parameter" below.

xfce-core-xxxxxxxx.iso ----- Default language (locale) is NOT set. You should choose from among pull-down list.
xfce-core-ja-xxxxxxxx.iso -- Default language (locale) is set to "ja_JP" for Japanese and JST.
