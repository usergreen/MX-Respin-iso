...
This updated version is now shown as "mx-respin-iso-21.2.1_x64 (January 13, 2023), which is based on Debian 11.6.

Default locale is en_US.UTF-8, but you can choose whatever locale you want to use at Boot Menu Option.
