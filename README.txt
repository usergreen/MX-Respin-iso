2022-05-18 14:17 JST
updated: 2022-06-07 17:54 JST

This is a README.txt file, so please read this text first before using MX-21.1 Respin ISO.
...
MX-21.1 Respin (Snapshot) for_x64
(+plus Japanese input [IME]*)
https://sourceforge.net/projects/mx-respin-iso/
https://linux.sakura.ne.jp/mx-respin-iso/mate-desktop/index.html

Modified from:
MX-21.1_x64 Wildflower April 9, 2022

"Origial" MX-21_x64
was officially released by MX Linux Dev Team
https://mxlinux.org/

* In order to enable Japanese input, click IME toolbar which appears at the right corner on the bottom. Then select item "Anthy". Now you can start Japanese input by pressing Shift + Space key, or alternatively "半/全 漢字" key if your keyboard is Japanese layout. To return to previous mode, just press the same key. 
