2023-02-05 07:20 UTC
updated: 02-05 13:27 UTC
...
**Known bugs
None. The bug that reported in the previous release was fixed.

Audio is muted by default (this is not a bug), and screen-lock is not supported.
...
Note:
xxxxxx.iso is identical to xxxxxx-ja.iso besides "boot parameters" below.

xxxxxx.iso ----- No default locale is set. You should choose from among pull-down list.
