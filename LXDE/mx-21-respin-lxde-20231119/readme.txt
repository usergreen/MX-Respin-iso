...
** Note
None. Audio is muted by default (this is not a bug).
...
Note:
mx-21-respin-lxde-xxxxxx.iso ----- No default locale is set yet. You should choose from among pull-down list.
