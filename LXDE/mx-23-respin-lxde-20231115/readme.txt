...
** Downloading sites
This ISO and an updated version is available at https://sourceforge.net/projects/mx-respin-lxde/
...
Modified from Community respin of
MX-23_CLI_x64.iso, 31 July 2023.
...
Note:
As for mx-23-respin-xxxxxx.iso, No default locale is set. So you should choose from among pull-down list.

You can choose whatever locale you want to use at Boot Menu Option. And also, to change another locale after system booting, logout a present desktop session. Then, click on the bottom center on the login screen, and choose "others" from a drop-down list. Simply logout and then login again can change a locale for a desktop session.
