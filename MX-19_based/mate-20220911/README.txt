...
This snapshot provides MATE desktop with core components, so is rather a minimal sized ISO, but contains Firefox browser, system utils, MX Tools, printing and file server, etc.
It is modified thoroughly from MX-19.3_base_x64. Thus, this version is now shown as "snapshot MX-19.4_base_x64 (11 September 2022)" at the boot menu.
