...
Note:
As for mx19-mate-core-20230129_0705.iso, no default language (locale) is set; that is "C" for English.
As for mx19-mate-core-ja-20230129_0719.iso, it is the Janasese version that is set "ja_JP.UTF-8".
