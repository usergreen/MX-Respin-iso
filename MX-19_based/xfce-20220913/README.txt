...
This snapshot provides Xfce core environment for desktop usage along with printing and file server. Though this ISO is modified thoroughly from MX-19.3_base_x64, it is up-to-date to the upstreams so far. Thus, the present version shows "snapshot MX-19.4_base_x64 (13 September 2022)" at the boot menu.
