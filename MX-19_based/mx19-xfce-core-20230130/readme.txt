...
This snapshot provides MATE Desktop environment along with office suite, mailer, printing and file server, etc. Though this ISO is modified thoroughly from MX-19.3_base_x64, it is up-to-date to upstreams so far. Thus, the present version shows "mx19-mate-core MX-19.4_base_x64 (29 January 2023)" at the boot menu.
...
Note:
As for mx19-xfce-core-20230130_0314.iso, the default language (locale) is set "English".
As for mx19-xfce-core-20230130_0333.iso, it is the Janasese version that is set "ja_JP.UTF-8".
...
This would lead to a good advantage for a user who wants to handle multiple languages at the same time, because the computer does NOT require him or her to reboot the system at all. 
