...
**IMPORTANT**
This ISO file is based on the Official MX-21.2.1_x64.iso, NOT based on unofficial MX-21.1_minimal_x64.
**IMPORTANT**

This snapshot is modified thoroughly from the official MX-21.2.1_x64 Wildflower 18 September 2022, and applied all latest updates so far. Thus, this released version is shown now as "MX-21.2.1_x64 (14 October 2022).

No desktop applications are removed from the original version; only added MATE desktop and several locales along with Chinese and Japanese inputs so as to be available out of the box without no internet connection for the first setup.
...
Modified from the Official release of
