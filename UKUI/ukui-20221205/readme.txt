...
Thus, this released version is now shown as "mx-respin-iso 21.2.1_x64 (December 05, 2022).
...
** Known bugs
Desktop icons do not appear at all and can not change the solid black background.
