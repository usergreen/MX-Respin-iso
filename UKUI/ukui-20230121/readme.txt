2023-01-21 18:30 JST
fixed: 01-21 18:52 JST
...
Thus, this released version is labeled "mx-respin-iso 21.3_x64 (bullseye-11.6) January 21, 2023 as shown on boot menu.
...
Note:
ukui-ja.iso is identical to ukui.iso besides "boot parameter" below.

ukui-xxxxxxxx.iso ----- No default language (locale) is set. You should choose from among pull-down list.
ukui-ja-xxxxxxxx.iso -- Default language (locale) is set to "ja_JP" for Japanese and JST.
