...
Many are supported, especially the below are good:
...
Note:
mx-21-respin-ukui-xxxxxxxx.iso ----- Default language (locale) is not set. You should choose another from among pull-down list.
