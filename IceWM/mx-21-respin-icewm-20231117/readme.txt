...
MX Snapshot --> mx-snapshot -c, or mx-snapshot (as root)
...
or https://archive.org/details/mx-respin-icewm
...
MX-21_minimal_x64.iso, Wildflowers 15 Jan 2023.
...
Note:
As for mx-21-respin-zzzfm-xxxxxx.iso, No default locale is set. So you should choose from among pull-down list.
