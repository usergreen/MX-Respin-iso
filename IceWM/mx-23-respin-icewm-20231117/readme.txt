...
MX Snapshot --> mx-snapshot -c, or mx-snapshot (as root), or iso-snapshot-cli
...
or https://archive.org/details/mx-23-respin-icewm-20231117_0932
...
Note:
As for mx-23-respin-spacefm-xxxxxx.iso, No default locale is set. So you should choose from among pull-down list.
