...
This snapshot is based on unofficial community re-spin of MX-21.3_minimal_x64 Wildflower 15 January 2023.
...
Modified from Community respin of MX-21.3_minimal_x64 Wildflower 15 January 2023
...
Note:
mx-21-respin-window_maker-xxx.iso ----- Default language (locale) is NOT set. So choose your desired locale from among the pull-down list.
