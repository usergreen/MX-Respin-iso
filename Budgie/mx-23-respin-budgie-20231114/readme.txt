...
This snapshot is modified thoroughly from 
MX-23_minimal_x64 Libretto July 31, 2023, and applied all latest updates so far.
...
Modified from MX Community respin of
MX-23_minimal_x64 Libretto July 31, 2023
...
Note:
This ISO image file: ----- Default locale is NOT set. You should choose another locale from among pull-down list.
