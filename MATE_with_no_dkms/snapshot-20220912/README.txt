...
update: 2022-09-12 12:50 JST

**************************************************************
This snapshot is an option for those who do NOT need dkms support, that means you are not required to auto-build kernels which takes much time when updates are automatically applied by APT. Users who manage legacy systems usually do not need dkms.

DKMS or Dynamic Kernel Module Support is a system that allows discrete kernel modules to update without the need to modify the entire kernel. See for details at https://linuxhint.com/dkms-linux/ and https://lwn.net/Articles/24060/
**************************************************************
...
This snapshot is modified thoroughly from MX-21.1_minimal_x64 Wildflower 18 May 2022, and applied all latest updates so far.
Thus, this released version is shown now as "MX-21.2_minimal_x64 Wildflower".
...
** Origin of the "snapshot-20220912_0306.iso"
